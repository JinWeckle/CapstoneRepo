...
.method public constructor <init>(Lcom/felhr/usbserial/UsbSerialInterface;)V
    ...
    iput-object v0, p0, Lcom/felhr/usbserial/SerialInputStream;->data:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iput-boolean v0, p0, Lcom/felhr/usbserial/SerialInputStream;->is_open:Z

    .line 16
    invoke-interface {p1, p0}, Lcom/felhr/usbserial/UsbSerialInterface;->read(Lcom/felhr/usbserial/UsbSerialInterface$UsbReadCallback;)I
...
.method public close()V
    ...
    iput-boolean v1, p0, Lcom/felhr/usbserial/SerialInputStream;->is_open:Z

    .line 40
    :try_start_0
    iget-object v1, p0, Lcom/felhr/usbserial/SerialInputStream;->data:Ljava/util/concurrent/ArrayBlockingQueue;
...
.method public onReceivedData([B)V
    ...
    .local v0, "b":B
    :try_start_0
    iget-object v3, p0, Lcom/felhr/usbserial/SerialInputStream;->data:Ljava/util/concurrent/ArrayBlockingQueue;
...
.method public read()I
    ...
    .line 22
    :goto_0
    iget-boolean v0, p0, Lcom/felhr/usbserial/SerialInputStream;->is_open:Z

    if-eqz v0, :cond_0

    .line 26
    :try_start_0
    iget-object v0, p0, Lcom/felhr/usbserial/SerialInputStream;->data:Ljava/util/concurrent/ArrayBlockingQueue;
