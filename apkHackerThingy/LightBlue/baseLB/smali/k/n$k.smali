...
.method constructor <init>(Ljava/lang/reflect/Method;ILk/f;Z)V
    ...
    iput-object p1, p0, Lk/n$k;->a:Ljava/lang/reflect/Method;

    iput p2, p0, Lk/n$k;->b:I

    iput-object p3, p0, Lk/n$k;->c:Lk/f;

    iput-boolean p4, p0, Lk/n$k;->d:Z
...
.method bridge synthetic a(Lk/p;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lk/n$k;->a(Lk/p;Ljava/util/Map;)V
...
.method a(Lk/p;Ljava/util/Map;)V
    ...
    iget-object v4, p0, Lk/n$k;->c:Lk/f;
    ...
    iget-boolean v1, p0, Lk/n$k;->d:Z

    invoke-virtual {p1, v2, v4, v1}, Lk/p;->c(Ljava/lang/String;Ljava/lang/String;Z)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lk/n$k;->a:Ljava/lang/reflect/Method;

    iget p2, p0, Lk/n$k;->b:I
    ...
    iget-object v1, p0, Lk/n$k;->c:Lk/f;
