...
.field private f:Lh/h0/i/c$a;

.field private g:Z

.field private final h:Lh/h0/i/i$b;

.field final i:Lh/h0/i/i$a;

.field final j:Lh/h0/i/i$c;

.field final k:Lh/h0/i/i$c;

.field l:Lh/h0/i/b;


# direct methods
.method constructor <init>(ILh/h0/i/g;ZZLh/s;)V
    .locals 2
    ...
    iput-object v0, p0, Lh/h0/i/i;->e:Ljava/util/Deque;
    ...
    iput-object v0, p0, Lh/h0/i/i;->k:Lh/h0/i/i$c;

    const/4 v0, 0x0

    iput-object v0, p0, Lh/h0/i/i;->l:Lh/h0/i/b;
    ...
    iget-object p1, p2, Lh/h0/i/g;->s:Lh/h0/i/m;
    ...
    iget-object p2, p2, Lh/h0/i/g;->r:Lh/h0/i/m;
    ...
    iput-object p1, p0, Lh/h0/i/i;->h:Lh/h0/i/i$b;

    new-instance p1, Lh/h0/i/i$a;

    invoke-direct {p1, p0}, Lh/h0/i/i$a;-><init>(Lh/h0/i/i;)V

    iput-object p1, p0, Lh/h0/i/i;->i:Lh/h0/i/i$a;

    iget-object p1, p0, Lh/h0/i/i;->h:Lh/h0/i/i$b;

    iput-boolean p4, p1, Lh/h0/i/i$b;->i:Z

    iget-object p1, p0, Lh/h0/i/i;->i:Lh/h0/i/i$a;

    iput-boolean p3, p1, Lh/h0/i/i$a;->g:Z

    if-eqz p5, :cond_0

    iget-object p1, p0, Lh/h0/i/i;->e:Ljava/util/Deque;
...
.method static synthetic a(Lh/h0/i/i;)Ljava/util/Deque;
    .locals 0

    iget-object p0, p0, Lh/h0/i/i;->e:Ljava/util/Deque;

    return-object p0
.end method

.method static synthetic b(Lh/h0/i/i;)Lh/h0/i/c$a;
    .locals 0

    iget-object p0, p0, Lh/h0/i/i;->f:Lh/h0/i/c$a;
...
.method private d(Lh/h0/i/b;)Z
    ...
    :try_start_0
    iget-object v0, p0, Lh/h0/i/i;->l:Lh/h0/i/b;
    ...
    :cond_0
    iget-object v0, p0, Lh/h0/i/i;->h:Lh/h0/i/i$b;

    iget-boolean v0, v0, Lh/h0/i/i$b;->i:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lh/h0/i/i;->i:Lh/h0/i/i$a;
    ...
    :cond_1
    iput-object p1, p0, Lh/h0/i/i;->l:Lh/h0/i/b;
...
.method a()V
    ...
    iget-boolean v0, v0, Lh/h0/i/i$b;->h:Z
    ...
    iget-boolean v0, v0, Lh/h0/i/i$a;->f:Z
...
.method a(Ljava/util/List;)V
    ...
    :try_start_0
    iput-boolean v0, p0, Lh/h0/i/i;->g:Z

    iget-object v0, p0, Lh/h0/i/i;->e:Ljava/util/Deque;

    invoke-static {p1}, Lh/h0/c;->b(Ljava/util/List;)Lh/s;
...
.method b()V
    ...
    iget-boolean v1, v0, Lh/h0/i/i$a;->f:Z
...
.method public d()Li/s;
    ...
    :try_start_0
    iget-boolean v0, p0, Lh/h0/i/i;->g:Z
...
.method public f()Z
    ...
    iget-boolean v3, v3, Lh/h0/i/g;->e:Z
...
.method i()V
    ...
    iput-boolean v1, v0, Lh/h0/i/i$b;->i:Z
...
.method public declared-synchronized j()Lh/s;
    .locals 2
    ...
    iget-object v1, p0, Lh/h0/i/i;->l:Lh/h0/i/b;
    ...
    iget-object v1, p0, Lh/h0/i/i;->j:Lh/h0/i/i$c;
...
.method public l()Li/u;
    .locals 1

    iget-object v0, p0, Lh/h0/i/i;->k:Lh/h0/i/i$c;
