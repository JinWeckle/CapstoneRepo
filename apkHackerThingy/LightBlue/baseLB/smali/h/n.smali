...
.method private a(Ljava/util/Deque;Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lh/n;->c:Ljava/lang/Runnable;

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-direct {p0}, Lh/n;->c()Z
...
.method private c(Lh/z$b;)I
    ...
    check-cast v2, Lh/z$b;

    invoke-virtual {v2}, Lh/z$b;->c()Lh/z;

    move-result-object v3

    iget-boolean v3, v3, Lh/z;->j:Z
    ...
    :cond_1
    invoke-virtual {v2}, Lh/z$b;->d()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1}, Lh/z$b;->d()Ljava/lang/String;
...
.method private c()Z
    ...
    :try_start_0
    iget-object v1, p0, Lh/n;->e:Ljava/util/Deque;
    ...
    iget-object v3, p0, Lh/n;->f:Ljava/util/Deque;
    ...
    :cond_0
    invoke-direct {p0, v2}, Lh/n;->c(Lh/z$b;)I
    ...
    check-cast v4, Lh/z$b;

    invoke-virtual {p0}, Lh/n;->a()Ljava/util/concurrent/ExecutorService;

    move-result-object v5

    invoke-virtual {v4, v5}, Lh/z$b;->a(Ljava/util/concurrent/ExecutorService;)V
...
.method b(Lh/z$b;)V
    ...
    invoke-direct {p0, v0, p1}, Lh/n;->a(Ljava/util/Deque;Ljava/lang/Object;)V
