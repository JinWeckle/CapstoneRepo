...
.method public static a(Ljava/lang/Object;Lb/i/b/b$b;Lb/i/b/b$a;Ljava/lang/Object;IZZ)Ljava/lang/Object;
    .locals 4
    ...
    invoke-interface {p1, p0}, Lb/i/b/b$b;->a(Ljava/lang/Object;)I
    ...
    invoke-static {p3, v1, p6}, Lb/i/b/b;->a(Ljava/lang/Object;Ljava/util/ArrayList;Z)Ljava/lang/Object;
    ...
    :cond_2
    invoke-static {p3, v1, p6}, Lb/i/b/b;->b(Ljava/lang/Object;Ljava/util/ArrayList;Z)Ljava/lang/Object;
...
.method public static a(Ljava/lang/Object;Lb/i/b/b$b;Lb/i/b/b$a;Ljava/lang/Object;Landroid/graphics/Rect;I)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<",
    ...
    invoke-static {p5, p4, v4, v0}, Lb/i/b/b;->b(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
...
.method private static a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1, p2}, Lb/i/b/b;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z

    move-result v0

    invoke-static {p0, p1, p3}, Lb/i/b/b;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_2
    invoke-static {p0, p1, p2}, Lb/i/b/b;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result p2

    invoke-static {p0, p1, p3}, Lb/i/b/b;->e(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
...
.method private static b(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    invoke-static {p1, p2, p0}, Lb/i/b/b;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    :cond_0
    invoke-static {p1, p3, p0}, Lb/i/b/b;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    invoke-static {p0, p1, p2}, Lb/i/b/b;->g(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result p2

    invoke-static {v0, p2}, Lb/i/b/b;->a(II)I

    move-result p2

    invoke-static {p0, p1, p3}, Lb/i/b/b;->c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v0

    invoke-static {p0, p1, p3}, Lb/i/b/b;->g(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result p0

    invoke-static {v0, p0}, Lb/i/b/b;->a(II)I
...
.method private static c(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {p0, p1, p2}, Lb/i/b/b;->d(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
...
.method private static e(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {p0, p1, p2}, Lb/i/b/b;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
