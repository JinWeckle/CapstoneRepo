...
.field public static final k:Lkotlinx/coroutines/l0;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lkotlinx/coroutines/l0;->j:J
...
.method private final declared-synchronized A()Z
    ...
    :try_start_0
    invoke-direct {p0}, Lkotlinx/coroutines/l0;->z()Z
...
.method private final declared-synchronized x()V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/y0;->w()V
...
.method public run()V
    ...
    invoke-virtual {v0, p0}, Lkotlinx/coroutines/d2;->a(Lkotlinx/coroutines/x0;)V
    ...
    invoke-interface {v0}, Lkotlinx/coroutines/e2;->c()V

    :cond_0
    const/4 v0, 0x0

    :try_start_0
    invoke-direct {p0}, Lkotlinx/coroutines/l0;->A()Z
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/l0;->x()V
    ...
    invoke-interface {v0}, Lkotlinx/coroutines/e2;->b()V

    :cond_1
    invoke-virtual {p0}, Lkotlinx/coroutines/y0;->u()Z
    ...
    invoke-interface {v10}, Lkotlinx/coroutines/e2;->a()J
    ...
    sget-wide v3, Lkotlinx/coroutines/l0;->j:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :goto_2
    :try_start_2
    invoke-static {v5, v6, v9, v10}, Lg/j0/e;->b(JJ)J
    ...
    :cond_a
    sget-wide v9, Lkotlinx/coroutines/l0;->j:J
    ...
    invoke-interface {v7, p0, v5, v6}, Lkotlinx/coroutines/e2;->a(Ljava/lang/Object;J)V
...
.method protected s()Ljava/lang/Thread;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/l0;->y()Ljava/lang/Thread;
