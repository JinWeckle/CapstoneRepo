...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lg/m0/g;->a(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :goto_1
    sput v0, Lkotlinx/coroutines/p;->e:I
...
.method private final p()Ljava/util/concurrent/ExecutorService;
    ...
    sget-boolean v2, Lkotlinx/coroutines/p;->f:Z

    const/4 v3, 0x0

    if-nez v2, :cond_4

    sget v2, Lkotlinx/coroutines/p;->e:I
    ...
    sget-object v4, Lkotlinx/coroutines/p;->g:Lkotlinx/coroutines/p;

    invoke-virtual {v4, v0, v2}, Lkotlinx/coroutines/p;->a(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/p;->r()I
...
.method private final declared-synchronized q()Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/p;->p()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lkotlinx/coroutines/p;->pool:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final r()I
    ...
    sget v0, Lkotlinx/coroutines/p;->e:I
    ...
    invoke-static {v0, v2}, Lg/j0/e;->a(II)I
...
.method public a(Lg/f0/f;Ljava/lang/Runnable;)V
    ...
    :try_start_0
    sget-object p1, Lkotlinx/coroutines/p;->pool:Ljava/util/concurrent/Executor;
    ...
    invoke-interface {v0, p2}, Lkotlinx/coroutines/e2;->a(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    :cond_2
    sget-object p1, Lkotlinx/coroutines/l0;->k:Lkotlinx/coroutines/l0;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/y0;->a(Ljava/lang/Runnable;)V
...
.method public final a(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    sget-object v0, Lkotlinx/coroutines/p$b;->e:Lkotlinx/coroutines/p$b;
