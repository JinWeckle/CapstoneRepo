...
.field w0:[Ljava/lang/CharSequence;

.field x0:[Ljava/lang/CharSequence;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/preference/d;->u0:Ljava/util/Set;
...
.method private l0()Landroidx/preference/MultiSelectListPreference;
    .locals 1
...
.method protected a(Landroidx/appcompat/app/c$a;)V
    ...
    iget-object v0, p0, Landroidx/preference/d;->x0:[Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Landroidx/preference/d;->u0:Ljava/util/Set;

    iget-object v4, p0, Landroidx/preference/d;->x0:[Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/preference/d;->w0:[Ljava/lang/CharSequence;
...
.method public c(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Landroidx/preference/d;->l0()Landroidx/preference/MultiSelectListPreference;
    ...
    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->S()[Ljava/lang/CharSequence;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroidx/preference/d;->u0:Ljava/util/Set;

    invoke-interface {v1}, Ljava/util/Set;->clear()V

    iget-object v1, p0, Landroidx/preference/d;->u0:Ljava/util/Set;

    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->T()Ljava/util/Set;

    move-result-object v2

    invoke-interface {v1, v2}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    iput-boolean v0, p0, Landroidx/preference/d;->v0:Z

    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->R()[Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroidx/preference/d;->w0:[Ljava/lang/CharSequence;

    invoke-virtual {p1}, Landroidx/preference/MultiSelectListPreference;->S()[Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/preference/d;->x0:[Ljava/lang/CharSequence;
...
.method public e(Landroid/os/Bundle;)V
    ...
    iget-boolean v0, p0, Landroidx/preference/d;->v0:Z
...
.method public i(Z)V
    ...
    iget-boolean p1, p0, Landroidx/preference/d;->v0:Z
    ...
    iget-object v0, p0, Landroidx/preference/d;->u0:Ljava/util/Set;
    ...
    iput-boolean p1, p0, Landroidx/preference/d;->v0:Z
