...
.method private a(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->c(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
...
.method private a(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lc/a/a/b/m/i;FF)F
    .locals 8

    invoke-virtual {p2}, Lc/a/a/b/m/i;->a()J

    move-result-wide v0

    invoke-virtual {p2}, Lc/a/a/b/m/i;->b()J

    move-result-wide v2

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lc/a/a/b/m/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Lc/a/a/b/m/h;->a(Ljava/lang/String;)Lc/a/a/b/m/i;

    move-result-object p1

    invoke-virtual {p1}, Lc/a/a/b/m/i;->a()J

    move-result-wide v4

    invoke-virtual {p1}, Lc/a/a/b/m/i;->b()J
    ...
    invoke-virtual {p2}, Lc/a/a/b/m/i;->c()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Lc/a/a/b/m/a;->a(FFF)F
...
.method private a(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lc/a/a/b/m/h;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Lc/a/a/b/m/h;->a(Ljava/lang/String;)Lc/a/a/b/m/i;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lc/a/a/b/m/h;
    ...
    :goto_1
    invoke-virtual {p2, p3}, Lc/a/a/b/m/h;->a(Ljava/lang/String;)Lc/a/a/b/m/i;
...
.method private a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    sget v0, Lc/a/a/b/f;->mtrl_child_content_container:I
...
.method private a(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lc/a/a/b/m/j;

    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->c(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F

    move-result v0

    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lc/a/a/b/m/j;

    invoke-direct {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->d(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
    ...
    check-cast v1, Lc/a/a/b/m/i;

    iget-object p4, p4, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast p4, Lc/a/a/b/m/i;
    ...
    invoke-virtual {v1, v0}, Lc/a/a/b/m/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {p4, p1}, Lc/a/a/b/m/i;->a(Landroid/animation/Animator;)V
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    instance-of v1, v8, Lc/a/a/b/r/d;
    ...
    check-cast v13, Lc/a/a/b/r/d;

    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lc/a/a/b/m/j;

    invoke-direct {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F

    move-result v1

    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lc/a/a/b/m/j;

    invoke-direct {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->b(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
    ...
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lc/a/a/b/m/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Lc/a/a/b/m/h;->a(Ljava/lang/String;)Lc/a/a/b/m/i;
    ...
    invoke-direct {v0, v1, v10, v11}, Lc/a/a/b/r/d$e;-><init>(FFF)V

    invoke-interface {v13, v0}, Lc/a/a/b/r/d;->setRevealInfo(Lc/a/a/b/r/d$e;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v13}, Lc/a/a/b/r/d;->getRevealInfo()Lc/a/a/b/r/d$e;

    move-result-object v0

    iget v0, v0, Lc/a/a/b/r/d$e;->c:F
    ...
    invoke-static/range {v2 .. v7}, Lc/a/a/b/w/a;->a(FFFFFF)F

    move-result v0

    invoke-static {v13, v1, v10, v0}, Lc/a/a/b/r/a;->a(Lc/a/a/b/r/d;FFF)Landroid/animation/Animator;

    move-result-object v9

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, v12, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lc/a/a/b/r/d;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v14}, Lc/a/a/b/m/i;->a()J
    ...
    iget v6, v0, Lc/a/a/b/r/d$e;->c:F

    invoke-static {v13, v1, v10, v11}, Lc/a/a/b/r/a;->a(Lc/a/a/b/r/d;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v14}, Lc/a/a/b/m/i;->b()J

    move-result-wide v4

    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lc/a/a/b/m/h;

    invoke-virtual {v0}, Lc/a/a/b/m/h;->a()J
    ...
    :goto_0
    invoke-virtual {v14, v9}, Lc/a/a/b/m/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v13}, Lc/a/a/b/r/a;->a(Lc/a/a/b/r/d;)Landroid/animation/Animator$AnimatorListener;
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_0
    instance-of p1, p2, Lc/a/a/b/r/d;

    if-eqz p1, :cond_1

    sget p1, Lc/a/a/b/r/c;->a:I
    ...
    sget-object p3, Lc/a/a/b/m/d;->a:Landroid/util/Property;
    ...
    :cond_3
    sget-object p2, Lc/a/a/b/m/d;->a:Landroid/util/Property;
    ...
    :goto_0
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lc/a/a/b/m/h;
    ...
    invoke-virtual {p2, p1}, Lc/a/a/b/m/i;->a(Landroid/animation/Animator;)V
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lc/a/a/b/m/j;

    invoke-direct {v10, v0, v1, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->c(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F

    move-result v4

    iget-object v5, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lc/a/a/b/m/j;

    invoke-direct {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->d(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
    ...
    check-cast v12, Lc/a/a/b/m/i;

    iget-object v5, v5, Landroid/util/Pair;->second:Ljava/lang/Object;

    move-object v13, v5

    check-cast v13, Lc/a/a/b/m/i;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lc/a/a/b/m/i;Lc/a/a/b/m/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_0
    invoke-virtual {v12, v14}, Lc/a/a/b/m/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v15}, Lc/a/a/b/m/i;->a(Landroid/animation/Animator;)V
...
.method private a(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lc/a/a/b/m/i;Lc/a/a/b/m/i;FFFFLandroid/graphics/RectF;)V
    .locals 0

    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lc/a/a/b/m/i;FF)F

    move-result p3

    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lc/a/a/b/m/i;FF)F
...
.method private b(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->d(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
...
.method private b(Landroid/view/View;)I
    ...
    invoke-static {p1}, Lb/g/k/v;->h(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method private b(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of p7, p2, Lc/a/a/b/r/d;
    ...
    invoke-interface {p2, p1}, Lc/a/a/b/r/d;->setCircularRevealScrimColor(I)V

    :cond_1
    sget-object p1, Lc/a/a/b/r/d$d;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p3, Lc/a/a/b/r/d$d;->a:Landroid/util/Property;
    ...
    :goto_0
    invoke-static {}, Lc/a/a/b/m/c;->a()Lc/a/a/b/m/c;
...
.method private c(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
    .locals 2
...
.method private c(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p2}, Lb/g/k/v;->l(Landroid/view/View;)F

    move-result p7

    invoke-static {p1}, Lb/g/k/v;->l(Landroid/view/View;)F
...
.method private d(Landroid/view/View;Landroid/view/View;Lc/a/a/b/m/j;)F
    .locals 2
...
.method private d(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of v0, p2, Lc/a/a/b/r/d;
    ...
    :cond_2
    sget-object p3, Lc/a/a/b/m/e;->b:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Lc/a/a/b/m/h;->a(Ljava/lang/String;)Lc/a/a/b/m/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Lc/a/a/b/m/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lc/a/a/b/r/d;Landroid/graphics/drawable/Drawable;)V
...
.method protected b(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Lc/a/a/b/m/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
